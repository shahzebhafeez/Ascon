...
module ascon_datapath (
    ...
    // FIX 1: Ciphertext is generated BEFORE the permutation runs.
    // C_i = P_i XOR current state_x0
    assign data_out = state_x0 ^ data_in;

    // FIX 3: Tag extraction is combinationally applied to the final state
    ...
    always @(posedge clk) begin
        if (!reset_n) begin
            ...
            // Priority 1: Initialization (FIX 2: Clean 320-bit concatenation)
